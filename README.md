...
## 🔄 CUDA to ROCm Migration
  ...
  * **[HIP Programming Guide](https://rocm.docs.amd.com/projects/HIP/en/docs-develop/what_is_hip.html)** - An introduction to HIP (Heterogeneous-compute Interface for Portability), AMD's C++ runtime API for creating portable GPU applications.
  * **[HIPIFY Tools](https://rocm.docs.amd.com/projects/HIP/en/docs-develop/how-to/hip_porting_guide.html)** - Official documentation for HIPIFY, a set of tools for automatically translating CUDA source code into HIP source code.
...
## 📊 Monitoring & Observability
  ...
  * **[System Health Checks](https://instinct.docs.amd.com/projects/system-acceptance/en/latest/mi300x/health-checks.html)** - Scripts and procedures for running health checks on MI300X systems.
